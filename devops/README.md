...
You need either a Ubuntu or Debian based system for ufac.br, enable SSH, and install a supported version of Python 3 on that system.
...
Deploy the stack defined in `devops/stacks/ufac.br.yml` to the remote server with:
