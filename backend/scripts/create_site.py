...
if site_id not in app.objectIds():
    ...
    portal_setup.runAllImportStepsFromProfile("profile-portal.ufac.volto:default")
    transaction.commit()

    if EXAMPLE_CONTENT:
        portal_setup.runAllImportStepsFromProfile("profile-portal.ufac.volto:initial")
        transaction.commit()
    app._p_jar.sync()
